...
public class AprilTagLockOn extends CommandPathPiece {
    /*For future purposes:
     * This command has been made for the event that we will need to lock on to areas with april tags.
     * The thinking behind this is that we may have the ability to offset the distance of our target by a distance equal to half the radius form the center of the tag. (There is a constant distance in between where we want to aim at and the center of the april tag)
     */
    ...
    private ShooterSubsystem barrel;
